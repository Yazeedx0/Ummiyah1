        ...
        <div className="flex justify-center items-center">
          ...
          >
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-[#1E3A8A]">تسجيل الدخول</h1>
              <p className="mt-2 text-[#475569]">مرحبا بعودتك! يرجى إدخال بيانات حسابك</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center mb-2">
                  <label htmlFor="password" className="block text-[#334155] font-medium">كلمة المرور</label>
                  <Link href="/forgot-password" className="text-[#4D79FF] text-sm hover:underline">
                    نسيت كلمة المرور؟
                  </Link>
                </div>
                <input
              ...
              <div className="mt-6 text-center">
                <p className="text-[#475569]">
                  ليس لديك حساب؟{" "}
                  <Link href="/register" className="text-[#4D79FF] font-medium hover:underline">
                    إنشاء حساب جديد
                  </Link>
                </p>
              </div>
